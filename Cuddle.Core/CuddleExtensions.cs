...
public static class CuddleExtensions {
    ...
    public static ECulture ToCulture(this string? culture) =>
        culture switch {
            "en" => ECulture.English,
            "en-US" => ECulture.EnglishUS,
            "en-GB" => ECulture.EnglishGB,
            "en-HK" => ECulture.EnglishHK,
            "fr" => ECulture.French,
            "fr-FR" => ECulture.FrenchFR,
            "fr-CA" => ECulture.FrenchCA,
            "it" => ECulture.Italian,
            "it-IT" => ECulture.ItalianIT,
            "de" => ECulture.German,
            "de-DE" => ECulture.GermanDE,
            "es" => ECulture.Spanish,
            "es-ES" => ECulture.SpanishES,
            "es-MX" => ECulture.SpanishMX,
            "es-419" => ECulture.SpanishLatAm,
            "da" => ECulture.Danish,
            "da-DK" => ECulture.DanishDK,
            "nl" => ECulture.Dutch,
            "nl-NL" => ECulture.DutchNL,
            "fi" => ECulture.Finnish,
            "fi-FI" => ECulture.FinnishFI,
            "sv" => ECulture.Swedish,
            "sv-SE" => ECulture.SwedishSE,
            "ru" => ECulture.Russian,
            "ru-RU" => ECulture.RussianRU,
            "pl" => ECulture.Polish,
            "pl-PL" => ECulture.PolishPL,
            "ar" => ECulture.Arabic,
            "ar-AE" => ECulture.ArabicAE,
            "ko" => ECulture.Korean,
            "ko-KR" => ECulture.KoreanKR,
            "ja" => ECulture.Japanese,
            "ja-JP" => ECulture.JapaneseJP,
            "zh-Hans" => ECulture.SimplifiedChinese,
            "zh-Hans-CN" => ECulture.SimplifiedChineseCN,
            ...
            "th" => ECulture.Thai,
            "th-TH" => ECulture.ThaiTH,
            "pt" => ECulture.Portuguese,
            "pt-PT" => ECulture.PortuguesePT,
            "pt-BR" => ECulture.PortugueseBR,
            _ => ECulture.None,
        };
}
